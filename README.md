...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-blue?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/wesam-alluhaybi-280a4233a/)
📍 Saudi Arabia
...
I'm a 3rd-year Software Engineering student passionate about building intelligent, scalable applications. a full-stack engineer with a strong focus on back-end architecture using Python and Node.js, and I enjoy building modern front-end experiences with React while integrating AI/ML into real-world products.


- 🎓 Studying Software Engineering @ Umm Al-Qura University
- 🔭 Currently building AI-powered web applications
- 🌱 Exploring **Frontend**, **RAG**, **Vector Databases**, **Agentic AI**, and **Microservices**
- 🤝 Open to collaboration on internship opportunities, open-source, and AI projects
- ⚡ Fun fact: I also follow crypto markets and sports
...
![Trae](https://img.shields.io/badge/Trae-0F172A?style=flat)
![Hugging Face](https://img.shields.io/badge/Hugging%20Face-FFCC4D?style=flat&logo=huggingface&logoColor=black)
![YOLOv8](https://img.shields.io/badge/YOLOv8-FF6F00?style=flat&logo=pytorch&logoColor=white)
...
### 🏛️ [Tabayun](https://github.com/wesambadr72)
**Multilingual Legal Comparison Platform**  
AI-powered legal document comparison tool with a RAG-based chatbot. Built with FastAPI, pgvector, and LangChain.
`Python` `FastAPI` `PostgreSQL` `pgvector` `LangChain` `Gemini`

---

### 🗑️ [BunkerModel](https://github.com/wesambadr72)
**Computer Vision Waste Detection System**  
Real-time waste detection using YOLOv8 for smart city applications.
`Python` `YOLOv8` `Computer Vision` `OpenCV`

---

### 🤖 [CryptoBot](https://github.com/wesambadr72)
**Cryptocurrency Trading Notification System**  
Automated crypto market alerts and signal tracking bot.
`Python` `Crypto APIs` `Telegram Bot` `Payments`
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=wesambadr72&bg_color=0d1117&color=c4b5fd&line=8b5cf6&point=6366f1&area=true&hide_border=true" width="100%" />
...
- 📨 Email: wesamse7@outlook.com

---

<div align="center">
  <i>I never dream of success. I work for it.</i>
</div>

<img src="https://capsule-render.vercel.app/api?type=waving&height=140&section=footer&color=0:000000,50:DDC52E,100:DDC52E" width="100%" />
